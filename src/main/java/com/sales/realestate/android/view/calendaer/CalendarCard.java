package com.sales.realestate.android.view.calendaer;
...
public class CalendarCard extends RelativeLayout {
	...
	private void init(Context ctx) {
		...
		layout.findViewById(R.id.iv_calendar_left).setOnClickListener(new OnClickListener() {
		...
		layout.findViewById(R.id.iv_calendar_right).setOnClickListener(new OnClickListener() {
