...
public class BitmapActivity extends KJActivity {
    ...
    private void save() {
        ...
        kjb.saveImage(this, "http://gdown.baidu.com/data/wisegame/9b2dea1666fa7f8e/baiduyun_430.apk",
                FileUtils.getSDCardPath() + "/123.apk",false,new HttpCallBack() {

                    @Override
                    public void onSuccess(String t) {
                        super.onSuccess(t);
                        toast("onSuccess(String t)");
                    }

                    @Override
                    public void onSuccess(byte[] t) {
                        super.onSuccess(t);
                        toast("onSuccess(byte[] t");
                    }

                    @Override
                    public void onSuccess(Map<String, String> headers, byte[] t) {
                        super.onSuccess(headers, t);
                        toast("onSuccess(Map<String, String> headers, byte[] t");
                    }

                    @Override
                    public void onSuccess(Bitmap t) {
                        super.onSuccess(t);
                        toast("onSuccess(Bitmap t");
                    }

                    @Override
                    public void onFailure(int errorNo, String strMsg) {
                        super.onFailure(errorNo, strMsg);
                        KJLoger.debug(errorNo+"");
                        KJLoger.debug(strMsg);
                        toast("onFailure(int errorNo, String strMsg");
                    }
                });
    }
