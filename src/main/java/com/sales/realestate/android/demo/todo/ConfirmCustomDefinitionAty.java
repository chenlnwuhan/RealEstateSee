 ...
 */
public class ConfirmCustomDefinitionAty extends KJActivity {
    ...
    public class CustomDefinetionHttpBusiness extends HttpBusiness.MyCallBack {
        @Override
        public void onSuccess(int uid, String returnStr) {
            super.onSuccess(uid, returnStr);
            switch (uid) {
                case HttpBusiness.HTTP_KEY_DEFINETION_DETAIL:
                    if (isError) {
    ...
    public void initView() {
        ...
        btn_confirm_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (isLook == -1) {
                    ...
                    HttpBusiness.updateCustomDefinitionParamsHTTP(BuildingID, CustomerID, ApplyID, String.valueOf(isLook), remork.trim(),textview_confirm_time.getText().toString(), new CustomDefinetionHttpBusiness());
                }
            }
        });
    }
