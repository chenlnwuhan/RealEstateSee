 ...
 */
public class ListOtherSpinnerAdapter extends BaseAdapter {
    ...
    public ListOtherSpinnerAdapter(ArrayList<SpinnerItemInfo> pList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            ListView.LayoutParams mLayoutParams= new ListView.LayoutParams(ListView.LayoutParams.FILL_PARENT, (int) AppContext.getCurrentActivity().getResources().getDimension(R.dimen.spinner_height));
        ...
        if(spinnerObjectArrayList.get(position).isCurrent()){
            convertView.setBackgroundColor(AppContext.getCurrentActivity().getResources().getColor(R.color.spinner_select));
        }else{
            convertView.setBackgroundColor(AppContext.getCurrentActivity().getResources().getColor(R.color.spinner_unselect));
        }
        return convertView;
    }
}
